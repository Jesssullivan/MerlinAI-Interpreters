/**
  * mediaInterface describes the elements of an image or spectrogram. 
  * @param {string} url is the image/spectrogram file. 
    * @param {number} id  [unique macaulay asset ID]
    * @param {string} src [macaulay asset url]
    * @param {string} attribution [author's name]
