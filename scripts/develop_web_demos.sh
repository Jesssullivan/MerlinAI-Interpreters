...
find '.' -name "*_render.html" -print -delete &> $PACKLOG &
...
if [[ "$OSTYPE" == "darwin"* ]] ; then
  ...
  echo "development: Detected fruit-based operating system, using browser cli 'open'"
  ...
  echo "development: Detected penguin, using browser cli 'google-chrome'"
