...
# (line ~80) for the Flask endpoint on Heroku (tmpui.herokuapp.com).
...
# thanks Grant!
tflite_model_fp = "./demos/models/liteStdOps/model.tflite"
labels_fp = "./demos/models/liteStdOps/labels.json"
...
if spectrogram.shape[0] < DESIRED_TIME_ROWS:
    ...
    spectrogram = tf.concat([spectrogram, tf.zeros([num_rows_to_add, spectrogram.shape[1]], dtype=tf.float32)], axis=0)
