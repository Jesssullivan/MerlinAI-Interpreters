...
const PaintPolygon = L.Control.extend({
    ...
    _createMenu: function() {
        ...
        // if (this.options.menu.onFinish !== null){
        //     this._finishedPainting = L.DomUtil.create('a', 'leaflet-control-paintpolygon-icon leaflet-control-paintpolygon-icon-trash', this._container);
        //     L.DomEvent.on(this._finishedSegmenting, 'click mousedown', this._clickFinish, this);
        // }
    },
