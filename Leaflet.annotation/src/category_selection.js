                ...
                <div className="row">
                    <div className="col">
                        <div className="form-group">
                            ...
                            <small className="form-text text-muted">Type the category name then choose from the list. Press enter to force all matching results to show, otherwise only a subset will show.</small>
