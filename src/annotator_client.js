...
implementations of `annotator_tool` for spectrogram annotations.
            ...
            .then((audioWaveform) => {
                ...
                function addAudioFunctions(annotatorRendered) {
                    ...
                    audioElement.addEventListener('canplaythrough', () => {
                        ...
                        console.log("Pixels / millisecond : " + pixels_per_ms);
...
let i = document.querySelector('#customFile').addEventListener('change', (ev)=> {
    ...
    for(let i = 0; i < ev.target.files.length; i++){
        ...
        // TODO: @Jess: Add render-in-place spectrogram generator
        //  - wonder if there is a more programmatic way to handle generic annotation tasks
