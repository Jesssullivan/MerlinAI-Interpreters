...
import {AnnotationInstance} from "./annotation_instance.jsx";
import {AnnotationSidebar} from "./annotation_sidebar.jsx";
    ...
    */
    componentDidMount() {
        ...
        try {
            ...
            console.log('didMountLeafletCallback error, continuing...')
        }
    }
