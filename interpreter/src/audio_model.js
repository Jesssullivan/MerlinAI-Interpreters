        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        _a.labels = _b.sent();
                        index_1.log('Loaded ' + this.labels.length + ' labels!.', 'audio_model.ts');
                        return [2 /*return*/];
                }
            });
        });
                ...
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, batches.forEachAsync(function (waveform_batch) {
                                ...
                                // @ts-ignore
                                var maxScore = Math.max.apply(Math, __spreadArray([], __read(scores)));
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        index_1.log("Extracting " + numWindows + " windows from audio waveform", "audio_model.ts");
                        curSampleIndex = 0;
                        batchResults = [];
                        i = 0;
                        _b.label = 2;
                    case 2:
                        ...
                        if (tf_waveform.shape[0] < waveformWindowSizeSamples) {
                            index_1.log("Padding waveform with zeros", "audio_model.ts");
                        ...
                        return [4 /*yield*/, ((_a = this.model) === null || _a === void 0 ? void 0 : _a.executeAsync({ 'waveform': input_waveform_batch_1, 'samplerate': input_samplerate_batch_1 }))];
                    case 3:
                        outputs = (_b.sent());
