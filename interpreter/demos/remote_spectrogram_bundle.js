...
function startAnnotating(images_data, categories, annotations, config) {
    ...
    function annotateImage(imageIndex) {
        ...
        imageEl.onload = function () {
            ...
            for (let i = 0; i < 5; i++) {
                $(".leaflet-image-holder").append($("<span></span>").css({
                    "content": "",
                    "width": "1px",
                    "height": "100%",
                    "display": "block",
