(function(factory) {
    ...
    function scope(target, options, originalOptions) {
        ...
        // Pips constants
        const PIPS_NONE = -1;
        const PIPS_NO_VALUE = 0;
        const PIPS_LARGE_VALUE = 1;
        const PIPS_SMALL_VALUE = 2;
        ...
        function updateHandlePosition(handleNumber, to) {
            ...
            scope_Handles[handleNumber].style[options.transformRule] = "translate(" + inRuleOrder(translation + "%", "0") + ")";
        ...
        function setZindex() {
            scope_HandleNumbers.forEach(function(handleNumber) {
                ...
                scope_Handles[handleNumber].style.zIndex = 3 + (scope_Handles.length + dir * handleNumber);
            });
        }
